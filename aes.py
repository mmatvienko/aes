"""
Implement AES-128 (10 rounds) and AES-256 (14 rounds)
ECB Mode
...
def subBytes(state):
    """ Left part of byte indexes into the height, right part into the width"""
    new_state = []
    for byte in state:
        right = byte & 0xf
        left = byte > 4
        new_state.append(Sbox[right * 0xf + left])
    return new_state
